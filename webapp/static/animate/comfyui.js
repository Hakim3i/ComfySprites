/** Animate Lab — ComfyUI job polling and status display. */



function animateComfyuiMethods() {
  ...
  return {
    ...
    comfyuiLab: ANIMATE_LAB_COMFYUI_LAB,
    ...
    registerTrackedJob(promptId) {
      ...
      if (typeof window.persistLabJob === 'function') {
        ...
        window.persistLabJob(ANIMATE_LAB_COMFYUI_LAB, {
    ...
    removeTrackedJob(promptId) {
      ...
      if (typeof window.removePersistedLabJob === 'function') {
        ...
        window.removePersistedLabJob(ANIMATE_LAB_COMFYUI_LAB, promptId);
    ...
    updateTrackedJobFromPoll(tracked, data) {
      ...
      if (tracked.status === 'complete') {
        ...
        if (previewUrl) {
          ...
          this.previewVideoUrl = previewUrl;
