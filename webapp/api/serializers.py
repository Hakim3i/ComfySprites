...
from ..db.models import Animation, Character, Location, Lora, Style, View
...
def design_entity_to_dict(c: Character) -> dict[str, Any]:
...
def location_to_dict(loc: Location) -> dict[str, Any]:
    ...
    return {
        ...
        "display_name": loc.display_name or loc.key,
